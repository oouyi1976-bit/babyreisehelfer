...
export const products: Product[] = [
  ...
  {
    id: 'nachtlicht-hotel',
    title: 'sympa wiederaufladbares Baby-Nachtlicht',
    category: 'hotel-mit-baby',
    amazonSearchTerm: 'sympa Baby Nachtlicht USB wiederaufladbar Reise Hotel',
    amazonProductUrl: 'https://www.amazon.de/dp/B0B5KXLNNS',
    affiliateUrl: 'https://www.amazon.de/dp/B0B5KXLNNS?tag=epic05e-21',
    affiliateStatus: 'ready',
    shortDescription:
